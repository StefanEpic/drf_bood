    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="allergies", to="bood_app.product", verbose_name="Аллергии"
            ),
        ),
        migrations.AddField(
            model_name="personcard",
            name="femaletype",
            field=models.ManyToManyField(
                blank=True, related_name="femaletype", to="bood_app.femaletype", verbose_name="Тип женщины"
            ),
        ),
        migrations.AddField(
            model_name="personcard",
        ...
        migrations.AddField(
            ...
            name="preferences",
            field=models.ManyToManyField(
                blank=True, related_name="preferences", to="bood_app.product", verbose_name="Предпочтения"
            ),
        ),
        migrations.CreateModel(
            name="Measurement",
